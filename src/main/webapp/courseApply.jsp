...
<body>
	...
	<center>
		<h2>
			<b><mark>Course Application Form</mark></b>
		</h2>
	</center>
	<br>
	<c:if test="${est.status eq 'Verified' }">
		...
		<form class="container" modelAttribute="contract"
			...
			<div class="form-group">
				<label class="control-label">Candidate Registration Number</label><font
					style="color: red;">*</font>
				<div class="input-group" style="z-index: 0;">
					<span class="input-group-addon"><i
						class="fa fa-location-arrow" aria-hidden="true"></i></span> <input
						name="canRegNo" placeholder="Candidate Reg No"
			...
			<div class="form-group">
				...
				<div class="input-group" style="z-index: 0;">
					<span class="input-group-addon"><i
						class="fa fa-location-arrow" aria-hidden="true"></i></span> <input
						name="estRegNo" placeholder="Establishment Reg No"
						class="form-control" type="text">
				</div>
			</div>
			...
			<div class="form-group col-md-6">
				...
				<div class="input-group" style="z-index: 0;">
					<span class="input-group-addon"><i class="fa fa-university"
						aria-hidden="true"></i></span> <input maxlength="50" name="estName"
						placeholder="Establishment Name" class="form-control" type="text">
				</div>

				<!-- Course Id-->
				<div class="form-group">
					<label class="control-label">Course Id</label><font
						style="color: red;">*</font>
					<div class="input-group" style="z-index: 0;">
						<span class="input-group-addon"><i
							class="fa fa-location-arrow" aria-hidden="true"></i></span> <input
							name="courseId" placeholder="Course Id" class="form-control"
							type="text">
					</div>
				</div>
