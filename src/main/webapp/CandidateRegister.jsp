...
<!-- Form Heading -->
 ...
 <header id="header">
  ...
  <section class="bcg" class="container" style="padding-top: 20px;">
    ...
    <form class="container" action="registerCandidate" method="post">
      <!-- Form Heading -->
...
<!-- Qualification details -->
      ...
      <!--Document Upload -->
		...
		<div class="form-group">
          ...
          <div class="input-group">
            <span class="input-group-addon"><i class="fa fa-files-o" aria-hidden="true"></i></span>
            <input class="form-control" name="aadhar" type="file" onchange="javascript:updateList();">
          </div>
        </div>
   ...
   <div class="form-group">
          ...
          <div class="input-group">
            <span class="input-group-addon"><i class="fa fa-files-o" aria-hidden="true"></i></span>
            <input class="form-control" name="eduCert" type="file" id="file"  onchange="javascript:updateList();">
          </div>
          <div id="fileList"></div>
        </div>
