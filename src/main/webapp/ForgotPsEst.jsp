...
<!-- Form Heading -->
      <center><h2><b><mark>Set New password for establishment</mark></b></h2></center><br>
      
 <section class="bcg" class="container" style="padding-top: 20px;">
  
    <form class="container" modelAttribute="establishment" action="forgotPsEst" method="post">
      <!-- Form Heading -->
      ...
      <!-- Form Fields -->
			...
			<div class="form-row">
				<div class="col-md-6 form-group">
					<label class="control-label">New Password</label><font
						style="color: red;">*</font>
					<div class="input-group" style="z-index: 0;">
